...
function LeftContainer() {
  return (
    ...
    <p style={StyleSheet.mainPoints}>Built with the advance React ( Next ) & Node Technologies</p>
    <p style={StyleSheet.mainPoints}>Much better SEO Optimization with SSR</p>
    ...
    <HireMe className='btn btn-hoverable'>Hire me </HireMe>
    <ChatBtn href={'https://wa.me/+918445840329'}><span style={{paddingRight:10}}>Chat with me</span><TelegramIcon/></ChatBtn>
    </div>
    </div>
